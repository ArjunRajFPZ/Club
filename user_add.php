         ...
         if ($conn->query($sql1) === TRUE){
          ...
          if ((move_uploaded_file($tempname, $folder))&&
             (move_uploaded_file($idtempname, $idfolder)))  {
              //session_start();
              $_SESSION['user_success_message'] = "Form Successfully Submitted";
...
<!-- photo -->
                     ...
                     <div class="form-group">
                         <div class="form-line">
                                 ...
                                 <img id="output" src="<?php echo $user_photo;?>" style="width: 20%;" />
                         </div>
                     </div>
...
<!-- id proof -->
                     <div class="form-group">
                         <div class="form-line">
                                 ...
                                 <img id="output2" src="<?php echo $user_id_proof;?>" style="width: 20%;" />
